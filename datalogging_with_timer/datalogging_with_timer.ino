/*
 * based of code from Nonsintetic Project (via GitHub)
 */

uint32_t sampleRate = 1; //sample rate of the sine wave in millis, 
                            //how many milliseconds until the TC5_Handler()
